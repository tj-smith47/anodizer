...
/// 3. the crate's [`tag_family_template`](anodizer_core::config::CrateConfig::tag_family_template).
///
...
fn scope_to_tag_family(
    ...
    let prefix = anodizer_core::git::tag_family_prefix(
