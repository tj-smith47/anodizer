...
pub use commits::{
    ...
    commit_in, commit_subject_in, commits_between_in, commits_with_subjects_in, get_all_commits,
    get_all_commits_in, get_all_commits_paths, get_all_commits_paths_in,
    ...
    is_branchlike, log_subjects_for_range, paths_changed_since_tag, paths_changed_since_tag_in,
    push_branch_in, reset_hard_in, resolve_rollback_identity, rev_parse_in, revert_commit_in,
