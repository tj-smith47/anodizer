...
pub fn generate_manifest(params: &KrewManifestParams<'_>) -> String {
    ...
    // GoReleaser parity (krew.go:237): sort platforms by URI descending.
...
///
/// GoReleaser parity: when an artifact has arch "all", it is expanded into
...
pub fn publish_to_krew(ctx: &Context, crate_name: &str, log: &StageLogger) -> Result<()> {
    ...
    // GoReleaser parity (krew.go): validate required fields before proceeding.
    if krew_cfg.description.as_ref().is_none_or(|s| s.is_empty()) {
...
mod tests {
    ...
    fn test_generate_manifest_basic() {
        ...
        assert!(manifest.starts_with("# This file was generated by anodize. DO NOT EDIT.\n"));
    ...
    fn test_generate_manifest_complete_structure() {
        ...
        assert_eq!(lines[4], "  name: kubectl-anodize");
