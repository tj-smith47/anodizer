...
impl anodizer_core::Publisher for NixPublisher {
    ...
    fn run(&self, ctx: &mut Context) -> anyhow::Result<anodizer_core::PublishEvidence> {
        ...
        // evidence recording — see `HomebrewPublisher::run` for the
        // long-form rationale on intent-driven evidence.
...
mod publisher_tests {
    ...
    /// filtered every selected crate out — NOT when `publish_to_nix`
