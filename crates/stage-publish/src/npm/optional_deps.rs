...
use super::manifest::{NpmTriple, npm_triple, warn_excluded_targets};
use super::platform_render::{
    render_metapackage_json, render_platform_json, render_platform_name, render_shim_js,
};
...
pub(super) fn join_bin_dir(dir: Option<&str>, name: &str) -> String {
    match dir {
...
pub(super) fn validate_npm_package_name(name: &str) -> Result<()> {
