...
// ---------------------------------------------------------------------------
const FORMULA_TEMPLATE: &str = r#"# This file was generated by anodizer (https://github.com/tj-smith47/anodizer). DO NOT EDIT.
# typed: false
...
mod header_pin_tests {
    #[test]
    fn formula_template_opens_with_the_shared_generated_header() {
        assert!(
            super::FORMULA_TEMPLATE.starts_with(crate::util::GENERATED_FILE_HEADER),
            "formula header drifted from util::GENERATED_FILE_HEADER"
        );
    }
}
