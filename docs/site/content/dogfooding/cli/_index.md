...
| `--nightly` | ✅ Verified | [anodizer `nightly.yml`](https://github.com/tj-smith47/anodizer/blob/master/.github/workflows/nightly.yml) (`0 4 * * *` cron, split/merge sharded); [cfgd `nightly.yml`](https://github.com/tj-smith47/cfgd/blob/v0.4.0/.github/workflows/nightly.yml) (`args: release --nightly --no-preflight` — publishes to all configured publishers) |
