...
| `anodize check config` (post-restructure) | 🤝 Help wanted | [`crates/cli/src/commands/check/config/mod.rs`](https://github.com/tj-smith47/anodizer/blob/master/crates/cli/src/commands/check/config/mod.rs) - post-restructure config validator; no release has exercised the new surface yet |
