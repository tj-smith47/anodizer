...
| `release.metadata` | ✅ Verified | `release.include_meta: true` attaches [v0.23.0 `metadata.json`](https://github.com/tj-smith47/anodizer/releases/download/v0.23.0/metadata.json) to every release; the companion [`artifacts.json`](https://github.com/tj-smith47/anodizer/releases/download/v0.1.1/artifacts.json) was attached through v0.1.1 and is now written to `dist/` only |
