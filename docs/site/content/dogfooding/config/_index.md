...
| `attestations.mode` | ✅ Verified | Both modes live. `mode: subjects`: [anodizer `.anodizer.yaml`](https://github.com/tj-smith47/anodizer/blob/master/.anodizer.yaml) (writes `dist/attestation-subjects.json`; anodizer-action feeds it to `actions/attest-build-provenance`) — the 19 KB [`attestation-subjects.json`](https://github.com/tj-smith47/anodizer/releases/download/v0.16.0/attestation-subjects.json) attached to v0.16.0. `mode: emit`: [brontes `.anodizer.yaml`](https://github.com/tj-smith47/brontes/blob/master/.anodizer.yaml) (self-contained in-toto SLSA-provenance v1 statement) — the live [`attestation.intoto.jsonl`](https://github.com/tj-smith47/brontes/releases/download/v0.2.1/attestation.intoto.jsonl) attached to brontes v0.2.1 |
| `attestations.artifacts` | ✅ Verified | [brontes `.anodizer.yaml`](https://github.com/tj-smith47/brontes/blob/master/.anodizer.yaml) (`artifacts: [source, sbom]` — the [v0.2.1 `attestation.intoto.jsonl`](https://github.com/tj-smith47/brontes/releases/download/v0.2.1/attestation.intoto.jsonl) covers the source tarball and its SBOM). anodizer leaves it unset (defaults to all artifact kinds under `mode: subjects`) |
