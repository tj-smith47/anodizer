...
| `changelog.footer` | ✅ Verified | [cfgd `.anodizer.yaml`](https://github.com/tj-smith47/cfgd/blob/master/.anodizer.yaml) (`footer: "_Generated by anodizer._"`) — anodizer itself now takes the derived release-body footer instead |
