...
| `snapcrafts[].name/title/summary/description` | ✅ Verified | [anodizer `.anodizer.yaml`](https://github.com/tj-smith47/anodizer/blob/master/.anodizer.yaml). Dogfooded through v0.9.1: [snapcraft.io/anodizer](https://snapcraft.io/anodizer) still serves the 0.9.1 revision uploaded 2026-06-13, the newest that ever published |
