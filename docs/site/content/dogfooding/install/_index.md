...
| **Krew** | ✅ Verified | cfgd plugin lives in [kubernetes-sigs/krew-index `plugins/cfgd.yaml`](https://github.com/kubernetes-sigs/krew-index/blob/master/plugins/cfgd.yaml) — merged via [PR #5633](https://github.com/kubernetes-sigs/krew-index/pull/5633) (v0.3.5) and [PR #5815](https://github.com/kubernetes-sigs/krew-index/pull/5815) (v0.4.0); the index currently serves v0.4.0 (the v0.5.0 PR was closed on a LICENSE-file packaging rule, fixed since) |
